...
namespace Simplex
{
	...
	public:
		...
		*/
		...
		/*
	USAGE: Rotates the camera along x axis
	ARGUMENTS: float angle = 1f -> angle of rotation
	OUTPUT: ---
	*/
		void RotateVertical(float angle = 1.0f);
		/*
		USAGE: Rotates the camera along y axis
		ARGUMENTS: float angle = 1f -> angle of rotation
		OUTPUT: ---
		*/
		void RotateHorizontal(float angle = 1.0f);
	};
} //namespace Simplex
