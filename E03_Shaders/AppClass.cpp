...
{
	m_uShaderProgramID = LoadShaders("Shaders//BasicColor.vs", "Shaders//dicoV_BasicColorComplementary.fs");
	glUseProgram(m_uShaderProgramID);
}
void AppClass::InitVariables(void)
{
	//points given in counter clockwise order (points to user)
	//clockwise would point into the screen and therefore be invisible because of normal (can be changed but is added complexity)
	...
	//VAO contains VBOs and states
	//set and bind vao first
